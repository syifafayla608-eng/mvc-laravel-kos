...
<div class="container mt-4 mb-5" style="max-width:600px">
    <div class="card shadow">
        <div class="card-header">
            <h5><i class="bi bi-plus-circle me-2"></i>Tambah Kamar - {{ $kos->nama_kos }}</h5>
        </div>
        <div class="card-body p-4">
            <div class="divider"></div>
            <form action="{{ route('kamar.store', $kos->id) }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="form-label">Nomor Kamar</label>
                    <input type="text" name="nomor_kamar" class="form-control @error('nomor_kamar') is-invalid @enderror" placeholder="cth: 101" value="{{ old('nomor_kamar') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="luas" class="form-control" placeholder="cth: 12" value="{{ old('luas') }}">
                </div>
